...
export default function Hero({isVisible}) {
  return (
    <>
      ...
      <div id="home" className=" md:flex w-screen   md:gap-[1%]  mt-[4rem] font-poppins  h-full hidden flex-cols-2 justify-between 3xl:gap-[13%] 3xl:justify-center gap-[10%] ">
        <div className="ml-[4rem] flex justify-center flex-col  "> 
        <h3 className="lg:mb-[3rem] text-[1rem]  p-[0.6rem] text-center w-[22rem] text-white font-[700] bg-[#232323] ">WELCOME TO VELOT FACTORY</h3>
        ...
        <p className="md:w-[23rem] lg:w-[27rem] text-[1rem] text-[#000000]  font-[500] mt-[2rem] "> At Velot, we deliver top-tier engineering solutions for all your mechanical needs. Trust our expertise 
...
<div style={{background:`url(${background})`}} className=" w-full bg-cover " >
      ...
      <div className=" m-auto  md:max-w-[750px] xl:max-w-[1250px] lg:max-w-[1100px] hidden md:grid grid-cols-2 lg:grid-cols-3   justify-around pb-[5.5rem] pt-[2rem]  " > 

<div className="text-white pt-[2rem]  m-auto w-[80%]">
  <h2 className="inline lg:font-[600] text-[1.4rem] font-[500] lg:text-[1.75rem] "  >01</h2>
  <h2 className="inline ml-[13%] font-[600] text-[1.4rem] md:font-[500]  lg:text-[1.75rem] ">Quality Materials</h2>
...
<div className="text-white pt-[2rem]  m-auto w-[80%] ">
  <h2 className="inline font-[600] text-[1.4rem] md:font-[500] lg:text-[1.75rem] "  >02</h2>
  <h2 className="inline text-[1.4rem] md:font-[500] ml-[13%] font-[600]  lg:text-[1.75rem] ">Experienced Team</h2>
...
<div className="text-white pt-[2rem]  m-auto w-[80%] ">
  <h2 className="inline font-[600] lg:text-[1.75rem] text-[1.4rem] md:font-[500]  "  >03</h2>
  <h2 className="inline ml-[11%] font-[600] text-[1.4rem] md:font-[500]  lg:text-[1.75rem] ">Unique Technologies</h2>
  ...
  <div   className=" bg-cover md:hidden flex   font-poppins w-screen h-screen justify-center  items-center text-center ">
        ...
        <h3 className=" m-auto mb-[1rem] px-[0.6rem] text-[0.9rem] font-[400] p-[0.6rem] flex justify-center items-center text-center  text-white bg-[#232323] " >WELCOME TO VELOT FACTORY</h3>
      ...
      <div className="text-white pt-[2rem] sm:w-[55%] m-auto w-[70%]">
        <h2 className="inline font-[600] text-[1.2rem] "  >01</h2>
        <h2 className="inline ml-[20%] font-[600]  text-[1.2rem] ">Quality Materials</h2>
      ...
      <div className="text-white pt-[2rem] sm:w-[55%] m-auto w-[70%] ">
        <h2 className="inline font-[600] text-[1.2rem] "  >02</h2>
        <h2 className="inline ml-[20%] font-[600]  text-[1.2rem] ">Experienced Team</h2>
        <p className= "mt-[2.5rem]  text-[1rem] " >
          With over 15 years of experience, we partner with owners and design professionals
      ...
      <div className="text-white pt-[2rem] sm:w-[55%] m-auto w-[70%] ">
        <h2 className="inline font-[600] text-[1.2rem] "  >03</h2>
        <h2 className="inline ml-[20%] font-[600]  text-[1.2rem] ">Unique Technologies</h2>
        <p className= "mt-[2.5rem]  text-[1rem] " >
        Our innovative technology transform Velot Factory, offering unparallel
        efficiency, groundbreaking solutions, and effortless integration for optimal performance
