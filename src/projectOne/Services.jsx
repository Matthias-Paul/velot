  ...
  return (
    <>
      <div id="services"   className="font-[poppins] mt-[5rem]"> 
        <h1 className=" lg:text-[2.5rem] xl:font-[600]  font-[500] text-center text-[#000000] text-[2rem] m-auto  ">Our Services </h1>
        <p className="md:font-[400] md:px-[3rem] lg:text-[1.3rem] xl:font-[500] font-[300] text-[#232323B8] pb-[4rem] px-[1.3rem] text-[1rem] pt-[2rem] text-center  m-auto "> Discover our top-tier services designed for you. We specialize in operational
            change management and optimizing workflows. </p>
        
        <div className="grid md:w-[770px] xl:w-[1150px] md:grid-cols-2  m-auto  xl:grid-cols-3 ">

        <div className=" rounded-[0.1rem] p-[2rem]  m-auto mb-[2rem] h=[22rem] w-[22rem] drop-shadow-sm border border-[0.5] ">
           ...
           <p className=" text-[0.9rem] mt-[1.3rem] font-[500]  text-[#000000]  "  >Keep your equipment running smoothly with our expert maintenance and
            repair services. Quick fixes, minimal downtime!
           </p>
           <div className="text-[#000000] cursor-pointer underline  mt-[2.5rem] font-[600]   text=[1rem] " >Read more &#8594;</div>
        </div>

        <div className=" rounded-[0.1rem] pt-[2.2rem] p-[1.8rem] m-auto mb-[2rem] h=[22rem] w-[22rem] drop-shadow-sm border border-[0.5] ">
           ...
           <p className=" text-[0.9rem] mt-[1.3rem] font-[500]  text-[#000000]  "  >Expert welding and fabrication services for precise and 
